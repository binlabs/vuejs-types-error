const H = globalThis, j = H.ShadowRoot && (H.ShadyCSS === void 0 || H.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, D = /* @__PURE__ */ Symbol(), V = /* @__PURE__ */ new WeakMap();
let et = class {
  constructor(t, e, s) {
...
const { is: dt, defineProperty: pt, getOwnPropertyDescriptor: ut, getOwnPropertyNames: $t, getOwnPropertySymbols: ft, getPrototypeOf: _t } = Object, N = globalThis, Z = N.trustedTypes, gt = Z ? Z.emptyScript : "", At = N.reactiveElementPolyfillSupport, E = (r, t) => r, M = { toAttribute(r, t) {
  switch (t) {
    case Boolean:
      r = r ? gt : null;
      break;
  ...
  return e;
} }, L = (r, t) => !dt(r, t), J = { attribute: !0, type: String, converter: M, reflect: !1, useDefault: !1, hasChanged: L };
...
const z = globalThis, K = (r) => r, T = z.trustedTypes, F = T ? T.createPolicy("lit-html", { createHTML: (r) => r }) : void 0, st = "$lit$", f = `lit$${Math.random().toFixed(9).slice(2)}$`, it = "?" + f, yt = `<${it}>`, A = document, w = () => A.createComment(""), C = (r) => r === null || typeof r != "object" && typeof r != "function", I = Array.isArray, mt = (r) => I(r) || typeof r?.[Symbol.iterator] == "function", k = `[ 	
    ...
    for (; (i = g.nextNode()) !== null && h.length < a; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) for (const l of i.getAttributeNames()) if (l.endsWith(st)) {
          const u = p[n++], $ = i.getAttribute(l).split(f), O = /([.?@])?(.*)/.exec(u);
          h.push({ type: 1, index: o, name: O[2], strings: $, ctor: O[1] === "." ? wt : O[1] === "?" ? Ct : O[1] === "@" ? Pt : R }), i.removeAttribute(l);
...
class St {
  ...
  u(t) {
    ...
    for (; h !== void 0; ) {
      if (n === h.index) {
        let c;
        h.type === 2 ? c = new U(o, o.nextSibling, this, t) : h.type === 1 ? c = new h.ctor(o, h.name, h.strings, this, t) : h.type === 6 && (c = new xt(o, this, t)), this._$AV.push(c), h = s[++a];
      }
...
class U {
  ...
  k(t) {
    ...
    const e = this._$AH;
    let s, i = 0;
    for (const o of t) i === e.length ? e.push(s = new U(this.O(w()), this.O(w()), this, this.options)) : s = e[i], s._$AI(o), i++;
...
Ut?.(P, U), (z.litHtmlVersions ??= []).push("3.3.3");
const Ot = (r, t, e) => {
  const s = e?.renderBefore ?? t;
  let i = s._$litPart$;
  if (i === void 0) {
    const o = e?.renderBefore ?? null;
    s._$litPart$ = i = new U(t.insertBefore(w(), o), o, void 0, e ?? {});
  }
  return i._$AI(r), i;
};
const B = globalThis;
...
const Mt = { attribute: !0, type: String, converter: M, reflect: !1, hasChanged: L }, Tt = (r = Mt, t, e) => {
...
ht([
  nt()
], x.prototype, "variation");
ht([
  nt({ type: Boolean })
], x.prototype, "disabled");
customElements.define("my-button", x);
